...
<header class="navbar-container">
    ...
    <nav>
      <ul>
        ...
        <li><a href="#my-hobbies-title">My Hobbies</a></li>
        <li><a href="#my-skills">My Skills</a></li>
      </ul>
    </nav>
  </header>
  <main data-scroll-container>
    <section class="landing-page" data-scroll-section data-scroll-repeat>
    ...
    <section class="about-me" data-scroll-section data-scroll-repeat>
    ...
    <section class="my-hobbies" data-scroll-section data-scroll-repeat>
      <h2 id="my-hobbies-title" data-scroll data-scroll-speed ="1">My Hobbies</h2>
      <section id ="my-hobbies-card" data-scroll data-scroll-speed="1">
    ...
    <section class="my-skills" data-scroll-section data-scroll-repeat>
      ...
      <ul>
        ...
        <li data-scroll data-scroll-speed="1.5">
          <img src="./image/css-svgrepo-com.svg" alt="CSS">
          <p>CSS</p>
        </li>
        <li data-scroll data-scroll-speed="1.5">
          <img src="./image/javascript-svgrepo-com.svg" alt="JavaScript">
